...
public class Main {
    public static void main(String[] args) {
        ...
        cadastrarDados("Daniel Hardman", "daiusdhaisudh", "22222222222", p1, pfController);

        // inicializando um objeto do tipo pessoaFisica
        PessoaFisica p2 = new PessoaFisica(1);
        // teste de insercao de dados na lista com o mesmo id
        cadastrarDados("Jessica Pearson", "uadhsuadhiuasd", "11111111111", p2, pfController);
        
        // inicializando um objeto do tipo pessoaFisica
        PessoaFisica p3 = new PessoaFisica(2);
        cadastrarDados("Harvey Specter", "endereco bla bla", "33333333333", p3, pfController);       
        ...
        atualizarDados("Jessica Pearson", "uadhsuadhiuasd", "11111111111", p2, pfController);
        exibirDados(pfController);
        System.out.println("**********");
        System.out.println();
        ...
        cadastrarDados("PEARSON HARDMAN", "endereco 1", "11223344", pj1, pjController);
        // inicializando um objeto do tipo pessoaJuridica
        PessoaJuridica pj2 = new PessoaJuridica(2);
        cadastrarDados("VIRGIN RIVER", "endereco 2", "55667788", pj2, pjController);
        // inicializando um objeto do tipo pessoaJuridica
        PessoaJuridica pj3 = new PessoaJuridica(3);
        cadastrarDados("RESTAURANTE BLA BLA", "endereco 3", "99110022", pj3, pjController);
        ...
        System.out.println("LISTA INSERINDO O MESMO ID");
        // teste de insercao de dados na lista com o mesmo id
        cadastrarDados("Atualizando nome", "atualizando endereco", "att identicador", pj4, pjController);
        exibirDados(pjController);
        System.out.println("**********");
        System.out.println();
        ...
        // atualiza os dados na lista
        atualizarDados("Atualizando nome", "atualizando endereco", "att identicador", pj4, pjController);
        exibirDados(pjController);
        System.out.println("**********");
        System.out.println();
    ...
    public static void cadastrarDados(String nome, String endereco, String identicador, Object obj, Object controller){
    ...
    // obj, recebe um objeto que sera cadastrado, pode ser PF ou PJ
    // controller, recebe um objeto que sera transformado em controlador PF ou PJ
    public static void atualizarDados(String nome, String endereco, String identicador,Object obj, Object controller){
